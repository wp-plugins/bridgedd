...
10. Re-enable _XCache_ or _eAccelerator_
...
* If you are not using the _BridgeDD Update_ plugin, **Please deactivate BridgeDD before auto updating to version 1.2.4!** This will insure the update is installed properly.
